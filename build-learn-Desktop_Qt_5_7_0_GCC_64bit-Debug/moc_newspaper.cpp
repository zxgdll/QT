...
void Newspaper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Newspaper::*_t)(const QString & ) const;
...
// SIGNAL 0
void Newspaper::newPaper(const QString & _t1)const
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(const_cast< Newspaper *>(this), &staticMetaObject, 0, _a);
}
